...
plt.title('Loss during training, half the examples')
plt.xlabel('Iteration')
plt.ylabel('Loss')
plt.savefig('losshalf.png')
plt.clf()
plt.plot(accuracy_history)
plt.title('Accuracy during training, half the examples')
plt.xlabel('Iteration')
plt.ylabel('Accuracy')
plt.savefig('Accuracyhalf.png')
plt.clf()
plt.plot(time_history,loss_history)
plt.title('Loss during training, half the examples')
plt.xlabel('Seconds')
plt.ylabel('Loss')
plt.savefig('Losstimehalf.png')
plt.clf()
plt.plot(time_history,accuracy_history)
plt.title('Accuracy during training, half the examples')
plt.xlabel('Seconds')
plt.ylabel('Accuracy')
plt.savefig('Accuracytimehalf.png')


unseen = predict(output(test_images,w1, b1, w2, b2, w3, b3))
with open("Results.txt","w") as f:
    f.write("half the examples " + str(accuracy(unseen, test_labels)))